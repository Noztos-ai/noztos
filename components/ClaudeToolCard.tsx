...
function BashBlock({ message }: { message: ChatMessage }) {
  ...
  return (
    <div className="ml-3 mt-0.5 chat-fluid w-full max-w-2xl overflow-hidden rounded border border-white/5 text-[11px] leading-5">
...
function ReadBlock({ message }: { message: ChatMessage }) {
  ...
  return (
    <div className="ml-3 mt-0.5 chat-fluid w-full max-w-2xl overflow-hidden rounded border border-white/5 bg-white/[0.02] text-[11px] leading-5">
...
export function ExitPlanModeBlock({ message }: { message: ChatMessage }) {
  ...
  return (
    <div className="ml-3 mt-0.5 chat-fluid w-full max-w-2xl overflow-hidden rounded border border-amber-500/20 bg-amber-500/[0.04] text-[11px] leading-5">

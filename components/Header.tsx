...
export function Header({ claudeState, githubState, githubUsername, userName }: HeaderProps) {
  ...
  return (
    <div>
          ...
          {userName ? (
            <>
              ...
              <button
                ...
                title="Settings"
                className="flex h-8 w-8 items-center justify-center rounded-full text-zinc-500 transition-colors hover:bg-white/5 hover:text-zinc-300"
              >
      ...
      <div className="flex w-full items-center gap-3 border-b border-white/10 px-6 py-2" style={{ backgroundColor: '#15151c' }}>
